...
/// A request that hearts or un-hearts a feed message.
public struct HeartFeedMessageRequest: Sendable {
	// MARK: - Properties
	...
	public func response() async throws -> FeedMessageUpdateResponse {
		let request = KKRequest<FeedMessageUpdateResponse>(
			path: KKEndpoint.Feed.Messages.heart(self.messageIdentity).endpointValue,
			method: .post,
