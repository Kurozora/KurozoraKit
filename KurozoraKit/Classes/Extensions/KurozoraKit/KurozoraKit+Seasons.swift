...
extension KurozoraKit {
	...
	///
	/// - Parameters:
	///    - seasonIdentity: The season identity for which the details should be fetched.
	...
	public func getDetails(forSeason seasonIdentity: SeasonIdentity, including relationships: [String] = [], completion completionHandler: @escaping (_ result: Result<[Season], KKAPIError>) -> Void) -> DataRequest {
		let seasonsDetails = KKEndpoint.Shows.Seasons.details(seasonIdentity.id).endpointValue
...
//			}
	...
	///
	/// - Parameters:
	///    - seasonID: The id of the season for which the episodes should be fetched.
