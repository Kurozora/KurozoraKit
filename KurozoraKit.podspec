#
# Be sure to run `pod lib lint KurozoraKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'KurozoraKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KurozoraKit.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'kiritokatklian' => 'casillaskhoren1@yahoo.com' }
